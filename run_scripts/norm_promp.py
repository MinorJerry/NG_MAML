...
from meta_policy_search.meta_algos.norm_pro_mp import ProMP
from meta_policy_search.meta_algos.norm_trpo_maml import TRPOMAML
...
if __name__=="__main__":
    ...
    parser.add_argument('--dump_path', type=str, default=meta_policy_search_path + '/log/norm_promp/HalfCheetahRandDirecEnv1')
    ...
    if args.config_file: # load configuration from json file
        ...
        config = {
            ...
            # ProMP config
            'inner_lr': 0.08,  # adaptation step size
