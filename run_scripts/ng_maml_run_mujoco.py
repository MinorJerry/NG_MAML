...
from meta_policy_search.meta_algos.ng_maml import NG_MAML
...
if __name__=="__main__":
    ...
    parser.add_argument('--dump_path', type=str, default=meta_policy_search_path + '/log/trpo/HalfCheetahRandDirecEnv1/')
    ...
    if args.config_file: # load configuration from json file
        ...
        config = {
            ...
            'step_size': 0.1, # size of the TRPO trust-region
            'n_itr': 3001, # number of overall training iterations
