...
class ProMP(MAMLAlgo):
    ...
    def build_graph(self):
        ...
        with tf.variable_scope(self.name):
            ...
            self.adapted_policies_params, self.adapt_input_ph_dict = self._build_inner_adaption_norm()
        ...
        with tf.variable_scope(self.name):
            ...
            for step_id in range(1, self.num_inner_grad_steps+1):
                ...
                for i in range(self.meta_batch_size):
                    ...
                    adapted_params_var = self._norm_adapt_sym(surr_loss, current_policy_params[i])
